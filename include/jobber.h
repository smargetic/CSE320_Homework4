 ...
 */
typedef enum {
    NEW,        // Newly created, not runnable 0
    WAITING,    // Runnable, waiting for an available runner 1
    RUNNING,    // Started, actively running 2
    PAUSED,     // Started, waiting to be resumed 3
    CANCELED,   // Canceled, pending termination 4
    COMPLETED,  // Terminated normally, exit status available 5
    ABORTED     // Terminated abnormally by a signal 6
} JOB_STATUS;
